...
<ul>
  <li><b><a href="https://github.com/Bendrox/AdeLIA_tatare_slm" target="_blank">Tatare LLM (AdeLIA)</a> 🔒</b>: a ~110M decoder-only Transformer (LLaMA/Mistral-style) trained <i>from scratch</i> for Tatar and Russian — Grouped-Query Attention, YaRN RoPE, RMSNorm, SwiGLU, BPE tokenizer, curriculum learning, BF16 on RTX 5090, served via FastAPI (training/inference, streaming, ONNX export, HF-compatible).</li>
